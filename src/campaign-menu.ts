...
function mountCampaignMenu() {
  ...
  style.textContent = `
    ...
    @media(max-width:640px){.campaign-menu-overlay{padding:8px}.campaign-menu-card{height:96vh;max-height:96vh;border-radius:14px}.campaign-menu-header{padding:18px}.campaign-list{padding:12px 12px 28px}.campaign-heading{grid-template-columns:1fr;gap:8px}.mission-row{grid-template-columns:32px 1fr auto;padding:12px 10px}.campaign-menu-button{padding:.52rem .7rem;font-size:11px}}
  `;
