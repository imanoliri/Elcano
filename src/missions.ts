...
const loaísaMissions: Mission[] = [
  {
    id: 'loaisa-1', number: 1, title: 'Departure for the Canaries', from: 'A Coruña', to: 'La Gomera', date: '24 July 1525',
  ...
  {
    id: 'loaisa-2', number: 2, title: 'Cross to Brazil', from: 'Canary Islands', to: 'Brazilian coast', date: 'Late 1525',
  ...
  {
    id: 'loaisa-3', number: 3, title: 'South to Patagonia', from: 'Brazilian coast', to: 'Patagonia', date: 'November 1525 – January 1526',
  ...
  {
    id: 'loaisa-4', number: 4, title: 'Find the Strait', from: 'Patagonia', to: 'Cape Virgenes', date: 'January 1526',
  ...
  {
    id: 'loaisa-5', number: 5, title: 'Through Magellan’s Strait', from: 'Cape Virgenes', to: 'Cape Pillar', date: 'January – May 1526',
  ...
  {
    id: 'loaisa-6', number: 6, title: 'Into the Pacific', from: 'Strait of Magellan', to: 'Central Pacific', date: 'May – July 1526',
  ...
  {
    id: 'loaisa-7', number: 7, title: 'Across to the Marshalls', from: 'Central Pacific', to: 'Maloelap region', date: 'August 1526',
  ...
  {
    id: 'loaisa-8', number: 8, title: 'The Marianas', from: 'Marshall Islands', to: 'Guam', date: 'August – September 1526',
  ...
  {
    id: 'loaisa-9', number: 9, title: 'Toward Mindanao', from: 'Guam', to: 'Mindanao', date: 'September 1526',
  ...
  {
    id: 'loaisa-10', number: 10, title: 'The Spice Islands', from: 'Mindanao', to: 'Tidore', date: 'September – October 1526',
...
export function worldStateForMission(mission: Mission): WorldState {
  return {
    time: new Date(`${mission.date.match(/\d{4}/)?.[0] ?? '1525'}-07-01T12:00:00Z`),
    elapsedHours: 0,
