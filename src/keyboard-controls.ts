export type KeyboardAction = 'helmPort' | 'helmStarboard' | 'sailsRaise' | 'sailsLower' | 'centerHelm' | 'pauseResume' | 'speed1' | 'speed4' | 'speed8' | 'speed16' | 'restart' | 'instructions' | 'missionMenu';
...
const controls: Definition[] = [
  ...
  { id: 'centerHelm', label: 'Center helm', hint: 'Return the rudder to centre.', defaults: ['c'] },
