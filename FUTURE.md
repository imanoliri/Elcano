...
- [x] Add deterministic day-to-day wind variation around the monthly climatology so voyages encounter plausible calms, stronger winds and directional shifts while remaining reproducible and static-first. The implemented field is spatially coherent at roughly 1,000 nm, evolves smoothly over about three days, uses regime-specific variability, and remains centred on the climatological speed and direction.
